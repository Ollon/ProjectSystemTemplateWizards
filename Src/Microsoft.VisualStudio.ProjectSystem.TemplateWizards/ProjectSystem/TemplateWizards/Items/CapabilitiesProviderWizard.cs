// ----------------------------------------------------------------------------
//  <copyright file="CapabilitiesProviderWizard.cs" company="Ollon, LLC">
...
{
    internal class CapabilitiesProviderWizard : ItemTemplateWizardBase
    {
        protected override void RunStartedCore(Dictionary<string, string> replacementsDictionary)
        {
            ...
            CodeAnalysis.Text.SourceText text = SourceCodeGenerator.GenerateCapabilitiesProviderSourceText(RootNamespace, RootName);
