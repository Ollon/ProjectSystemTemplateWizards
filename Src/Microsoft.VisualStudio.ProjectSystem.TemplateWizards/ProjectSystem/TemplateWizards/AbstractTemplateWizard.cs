...
namespace Microsoft.VisualStudio.ProjectSystem.TemplateWizards
{
    /// <summary>
    /// Provides a default implementation of <see cref="IWizard"/>
    /// </summary>
    internal class AbstractTemplateWizard : IWizard
    {

        protected RoslynSolutionService Service
        {
            get;
        }

        protected AbstractTemplateWizard()
        {
            Service = new RoslynSolutionService();
        }
